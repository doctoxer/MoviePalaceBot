...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('• ᴏᴡɴᴇʀ •', url="https://t.me/ZenyxZone"),
                    InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ •', url='https://t.me/MoviePalaceSupport')
                ],[
                    InlineKeyboardButton('• ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ •', url="https://t.me/+3GPZfYMefVQ0ZjNl")
                  ]]
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "ɢᴏᴏᴅ ɴɪɢʜᴛ 🌙"
        m=await message.reply_text("<i>ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ <b>ᴍᴏᴠɪᴇ ᴘᴀʟᴀᴄᴇ</b>.\nᴇɴᴊᴏʏɪɴɢ ʟɪꜰᴇ ʜᴀᴀ!...</i>")
        ...
        await m.delete()        
        m=await message.reply_sticker("CAACAgIAAxkBAAIe_GZ3ODNc9d5U1EhW6R1IP8uWw9UJAALvOQACt9WYSKNPMZv-hrXbNAQ") 
...
async def donate_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("• ᴅᴏɴᴀᴛᴇ • ", url="https://t.me/TeamMoviePalace/19"),
                InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ •", url="https://t.me/MoviePalaceSupport")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def help_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("• ᴏᴘᴇɴ ɪɴ ᴘʀɪᴠᴀᴛᴇ •", url="https://t.me/ZenyxZone"),
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def support_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/MoviePalaceSupport"),
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/TeamMoviePalace")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/PrashanthanCare_Bot</code></b>")
