...
async def ai_generate(client, message):
    ...
    s = await message.reply_sticker("CAACAgUAAxkBAAIgSWZ_Dg9lhpZpO02nVLq8b6GjEe23AAK-AwACwhYJV2g1Mmta31qPNAQ")
  
    if user_input.lower() in ["who is your owner", "what is your owner name"]:  
        buttons = [[
            InlineKeyboardButton("ɢʀᴏᴜᴘ", url="https://t.me/MoviePalaceSupport")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_sticker("CAACAgUAAxkBAAIgSWZ_Dg9lhpZpO02nVLq8b6GjEe23AAK-AwACwhYJV2g1Mmta31qPNAQ")
...
async def ai_generate_private(client, message):
  buttons = [[
    InlineKeyboardButton("ᴜsᴇ ɪɴ ɢʀᴏᴜᴘ", url="https://t.me/MoviePalaceSupport")
  ]]
  reply_markup = InlineKeyboardMarkup(buttons)
  await message.reply_sticker("CAACAgUAAxkBAAIgSWZ_Dg9lhpZpO02nVLq8b6GjEe23AAK-AwACwhYJV2g1Mmta31qPNAQ")
