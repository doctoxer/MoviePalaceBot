...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://telegram.me/MoviePalaceSupport')
            ]]
        ...
        buttons = [[
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://telegram.me/MoviePalaceSupport'),
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://telegram.me/TeamMoviePalace')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_photo(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton("ᴄᴜꜱᴛᴏᴍᴇʀ ᴄᴀʀᴇ", url=f"https://t.me/PrashanthanCare_Bot"),
                                                                           InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://telegram.me/TeamMoviePalace')
                                                                        ]]
                                                 ),
