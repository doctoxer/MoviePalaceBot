        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧', url ='https://t.me/TeamMoviePalace/8')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧", url=f"https://t.me/TeamMoviePalace/8")]])
    )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ꜱᴜᴩᴩᴏʀᴛ", url=f"https://t.me/PrashanthanCare_Bot"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/TeamMoviePalace/8")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/TeamMoviePalace/8")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('• ᴄʜᴀɴɴᴇʟꜱ •', url='https://t.me/+lJ5VORDK-j8yMTc1'),
                    InlineKeyboardButton('• ɢʀᴏᴜᴩ •', url='https://t.me/+3AR8iOF-8ENiYmQ9')
                ],[
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(6456879892))
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(6456879892))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(6456879892))
        ],[
            InlineKeyboardButton("• ᴄᴜꜱᴛᴏᴍᴇʀ ᴄᴀʀᴇ •", url="https://t.me/PrashanthanCare_Bot"),
            InlineKeyboardButton("• ꜱᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ •", url="https://t.me/MoviePalace_Support")
        ],[            
        ...
        buttons = [[
            InlineKeyboardButton('⚜️ ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ɢᴇᴛ ꜰʀᴇᴇ ᴛʀɪᴀʟ', user_id=int(6456879892))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(6456879892))
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton ('• ᴠɪsɪᴛ ᴏᴜʀ ᴄᴏᴍᴍᴜɴɪᴛʏ •', url="t.me/MoviePalaceSupport")
        ], [
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(6456879892))
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('× ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ ×', url="https://t.me/TeamMoviePalace/8")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="https://t.me/+3AR8iOF-8ENiYmQ9"),
            InlineKeyboardButton('• ꜱᴜᴘᴘᴏʀᴛ •', url="https://t.me/+yv4YpEVixsczZWM9")
       ],[
            InlineKeyboardButton('• ꜱᴇʀɪᴇꜱ •', url="https://t.me/+0N0DnFijuJc3NzA9"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇ •', url="https://t.me/+lJ5VORDK-j8yMTc1")
       ],[
            InlineKeyboardButton('• ᴀɴɪᴍᴇ •', url="https://t.me/+W1UXuvBV9RM5OTI1")
       ],[ 
...
async def auto_filter(client, msg, spoll=False):
    ...
    #     ]
        ...
        btn.insert(0, [
            InlineKeyboardButton("", url=f"https://t.me/TeamMoviePalace/19"),
            InlineKeyboardButton("sᴇɴᴅ ᴀʟʟ", callback_data=f"sendfiles#{key}")
        ])
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        button = [[
                   InlineKeyboardButton("ɢᴏᴏɢʟᴇ ɴᴏᴋᴋᴜ ʙʀᴜʜ!", url=f"https://www.google.com/search?q={reqst_gle}")
        ]]
        if NO_RESULTS_MSG:
