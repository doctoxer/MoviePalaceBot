...
OWNER_ID = environ.get('OWNER_ID', '6456879892')
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6456879892').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002218739794') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002144072367') # request channel id ( make sure bot is admin )
...
BOT_USERNAME = environ.get("BOT_USERNAME", "ZenyxZone")
BOT_NAME = environ.get("BOT_NAME", "𝐙𝐞𝐧𝐲𝐱")
BOT_ID = environ.get("BOT_ID", "6456879892")
S_GROUP = environ.get('S_GROUP', "MoviePalaceSupport")
S_CHANNEL = environ.get('S_CHANNEL', "TeamMoviePalace")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoviePalace_Off')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+wbEHPihg9Q0zZTY1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/TeamMoviePalace/10') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool((environ.get('IS_TUTORIAL', "False")))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @TeamMoviePalace')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MoviePalaceSupport') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002144072367'))
